...
<head>
  ...
  <title>Workshop Booking System</title>
  ...
  <div class="page-container">
    <div class="page-wrapper" align="center" style="margin-top:50px;margin-bottom: 0px;bottom:0;">
      <div class="row" style="align-content: center;">
        <img src="<?php echo base_url() ?>uploads/logo.png" alt="Electric Motor Workshop" style="height: 200px; width: 500px;">
      </div>
      <div class="row">
        <h3><i>Workshop Booking System</i></h3>
      </div>
    </div>
    <div id="wrapper">
