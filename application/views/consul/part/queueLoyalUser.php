...
$card = $this->db->query("select *, 
    ...
    from counter where counter_type = 'Product Purchase' order by counter_number asc")->result();
?>

<!-- <div class="" style="text-align:center;margin-top: -5%;margin-left: 25%;margin-bottom:1%">
    <strong style="font-size:30px;color:white">Loyal User</strong>
</div> -->
<div class="col-lg-12" style="width:129%">
    ...
    foreach ($card as $item) {
        ...
        <div class="col-lg-2 card-slide">
            ...
            <div class="row <?php if ($item->counter_status == 1) {
                                echo "card-sign-red";
                            } else {
                                echo "card-sign-green";
                            } ?>">
                <span style="color: white;font-size: 20px;"><?php if ($item->counter_status == 1) {
                                                                echo $item->member;
                                                            } else {
                                                                echo "Empty";
                                                            } ?> </span>
