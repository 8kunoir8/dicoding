<?php
    $data = $this->db->query("select queue.id, is_called, is_done, date, ticket, counter_id, member_id, member.`name` as name from queue
                              ...
                              where is_called = 0 and is_done = 0 and counter_id = 'Empty' and date = curdate() order by ticket desc limit 6;")->result();
?>
<div class="left-card-bottom">
  <div class="row" style="text-align:center">
        <small class="pull-left" style="color: white;font-size:20px;margin-top: 5%;margin-left: 25%;"><strong>Next Customer</strong></small>
    </div>
    <!-- <hr> -->
